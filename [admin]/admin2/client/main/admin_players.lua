...
function aPlayersTab.Create(tab)
    ...
    aPlayersTab.SetDimension = guiCreateButton(0.71, 0.485, 0.13, 0.04, "Set Dimens.", true, tab, "setdimension")
    aPlayersTab.SetInterior = guiCreateButton(0.85, 0.485, 0.13, 0.04, "Set Interior", true, tab, "setinterior")
