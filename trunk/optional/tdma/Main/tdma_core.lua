...
if xDebug then outputDebugString ( "... DONE" ) end
	...
	for k,v in ipairs(playerElementTree) do
	    ...
	    setPlayerStat ( v, 69, 1000 )
	    setPlayerStat ( v, 70, 1000 )
	    setPlayerStat ( v, 71, 1000 )
	    setPlayerStat ( v, 72, 1000 )
	    setPlayerStat ( v, 73, 1000 )
	    setPlayerStat ( v, 74, 1000 )
	    setPlayerStat ( v, 75, 1000 )
	    setPlayerStat ( v, 76, 1000 )
	    setPlayerStat ( v, 77, 1000 )
	    setPlayerStat ( v, 78, 1000 )
	    setPlayerStat ( v, 79, 1000 )
