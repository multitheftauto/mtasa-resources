...
local function onClientCursorMove_cursor(cursorX, cursorY, absoluteX, absoluteY, worldX, worldY, worldZ)
...
function detachElement()
	...
	triggerServerEvent("syncProperty", selectedElement, "position", {tempPosX, tempPosY, tempPosZ})
...
function disable()
	...
	-- unbindKey(cc.zoom_in, "down", zoomWithMouseWheel)
	-- unbindKey(cc.zoom_out, "down", zoomWithMouseWheel)
end
...
function enable()
	...
	-- bindKey(cc.zoom_in, "down", zoomWithMouseWheel) --zoom in
	-- bindKey(cc.zoom_out, "down", zoomWithMouseWheel) --zoom out
end
